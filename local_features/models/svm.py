...
train_trans_bovw = pd.read_csv('../data/train_orb_10.csv')
test_trans_bovw = pd.read_csv('../data/test_orb_10.csv')
...
print('[INFO] model SVM with scaler and hyperparameter tuning')
